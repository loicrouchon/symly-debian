...
upstream_tarball_url="https://github.com/loicrouchon/symly/archive/refs/heads/features/debian-source-package.tar.gz"
curl -sL "${upstream_tarball_url}" -o "${upstream_tarball}"
# TODO remove
#tar --exclude=.git -czf ../../src.tar.gz ../../../symly
#cp ../../src.tar.gz symly_0.9.4.orig.tar.gz
